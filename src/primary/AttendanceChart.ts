...
export const makeChart = (selectorId: string, attendance: number, color: string, animationDuration: number) => {
  ...
  updateChart(selectorId, attendance, 0, color, animationDuration);
};

export const updateChart = (selectorId: string, attendance: number, formerAttendance: number, color: string, animationDuration: number) => {
...
export const makeCanvasChart = (selectorId: string, attendance: number, color: string) => {
  makeChart(selectorId, attendance, color, 0);
