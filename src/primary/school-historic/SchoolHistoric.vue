<template>
  <div class="has-background-white card">
    ...
    <div class="card-content">
      ...
      <b-field v-if="schoolHistoricDataSet.chartData.length > 0 && !printable">
        <b-slider
          :value="historicInterval"
          :min="0"
          :max="schoolHistoricDataSet.chartData.length - 1"
          :step="1"
...
<script lang="ts" src="./SchoolHistoric.component.ts"></script>
